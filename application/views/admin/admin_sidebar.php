        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <a href="#"><img src="#" alt="SENEDU" class="img-responsive logo"></a>
                </div>
                <!-- end logo -->
            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        <li class=""><a href="index.html"><i class="lnr lnr-home"></i> <span>Beranda</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-phone-handset"></i> <span>Group Chat</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-pencil"></i> <span>Informasi</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-graduation-hat"></i> <span>Passing Grade</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-home"></i> <span>Data Sekolah</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-screen"></i> <span>Ujian</span></a></li>
                        <li class="active"><a href="index.html"><i class="lnr lnr-book"></i> <span>Event</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-users"></i> <span>Member</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-tag"></i> <span>Saldo</span></a></li>
                        <li class=""><a href="index.html"><i class="lnr lnr-home"></i> <span>Pengaturan</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
